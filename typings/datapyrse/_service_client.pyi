...
class ServiceClient:
    ...
    is_ready: bool
    fetch_relationship_metadata: Incomplete
    logger: Incomplete
    def __init__(self, tenant_id: str, resource_url: str, client_id: str = '51f81489-12ee-4a9e-aaae-a2591f45987d', scope: list[str] | None = None, prompt: Prompt = ..., pre_fetch_relationship_metadata: bool = False, logger: Logger = ...) -> None: ...
    metadata: Incomplete
    ...
    def associate(self, associate_request: AssociateRequest, logger: Logger | None = None) -> None: ...
